        ...
        <div className="topheader">
            <AppBar position="fixed" className="MainHeader">
                <Toolbar className="header_padding">
                    <div className="header_link_color"><img  className="logo_img" onClick={() => props.history.push("/home")} src={logo}  /><strong onClick={() => props.history.push("/home")}>EDUCATION</strong></div>
                    <div className="header_grow" />
                    <div className="header_links">
                        <span className="header_link_color" onClick={() => props.history.push("/home")}>Home</span>
                        <span className="header_link_color" onClick={() => props.history.push("/about")}>About</span>
                        <span className="header_link_color" onClick={() => props.history.push("/support")}>Supports</span>
                        <span className="header_link_color" onClick={() => props.history.push("/Search_chapter")}>Course</span>
                    ...
                    <div className="mobile_Burger_Menu">
                        ...
                        <div id="mySidenav" className="sidenav">
                            ...
                            <span className="logout_Pointer_cursor" onChange={() => props.history.push("/support")} >
                                Supports
                            </span>
